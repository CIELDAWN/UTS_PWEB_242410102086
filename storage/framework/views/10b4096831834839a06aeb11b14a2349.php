...
<?php $__env->startSection('title', 'Dashboard - TravelKuy'); ?>
...
<section class="hero">
    <div class="container">
        <div class="username-welcome">Selamat Datang, <?php echo e($username); ?>! 👋</div>
        <h1>Siap Beraksi Gak?</h1>
        <p>Jelajahi destinasi menakjubkan dan ciptakan kenangan yang tak terlupakan</p>
        <a href="<?php echo e(route('pengelolaan', ['username' => $username])); ?>" class="btn-primary">Jelajahi Destinasi</a>
    </div>
</section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Pweb\PraktikumUTS\resources\views/dashboard.blade.php ENDPATH**/ ?>